...
// *To customize origin and destination:
// 1) Comment the line above, put your destination below in var mapdata:
//var mapdata = { destination: new google.maps.LatLng(YOUR_DEST_LAT, YOUR_DEST_LANG) };

// 2) See START: and END: comments below to toggle out hard-coded locations and
//    toggle in live geolocation for your actual origin location.

// A tutorial discussion this app (AppLaud / Eclipse Version) is here:
